...
using System.Net;
using System.IO;
public class voice8 : MonoBehaviour {
	bool setactived1;
	...
	public void download1()
	{
		...
		LoadURL("https://storage.tarafdari.com/contents/user221704/content-sound/nirvana_-_the_man_who_sold_the_world.mp3","18.mp3");
	}
	public  void playbtn1()
	{
		WWW www = new WWW("file:///" + Application.persistentDataPath + "/18.mp3");
		while (!www.isDone)
		{
